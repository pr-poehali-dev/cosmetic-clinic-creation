...
const reviews = [
  ...
  },
  {
    name: "Алексей М.",
    date: "апрель 2025",
    text: "Сначала скептически отнёсся к косметологу, но жена уговорила попробовать. Сделал чистку и мезотерапию — результат ощутимый. Кожа стала лучше выглядеть, коллеги заметили. Буду ходить.",
    rating: 5
  },
  {
    name: "Дмитрий К.",
    date: "март 2025",
    text: "Пришёл на капельницу «Витаминный заряд» — прилив сил был уже на следующее утро. Никакой показухи, всё по делу. Профессионал своего дела.",
    rating: 5
  },
];

const portfolioItems = [
  { label: "Чистка лица — чистые поры, ровный тон", src: "https://cdn.poehali.dev/projects/4a1b1793-1bde-4476-a16b-45471d2a62ec/files/182b8fd7-8e24-4b4a-beac-cc018d2bfe2d.jpg" },
  { label: "Мезотерапия — питание и сияние кожи", src: "https://cdn.poehali.dev/projects/4a1b1793-1bde-4476-a16b-45471d2a62ec/files/4ba0f812-3b6b-430d-ba41-175e5da3f6c2.jpg" },
  { label: "Капельница красоты — изнутри наружу", src: "https://cdn.poehali.dev/projects/4a1b1793-1bde-4476-a16b-45471d2a62ec/files/6c13264b-ff06-4dbb-bc5d-36b6f6ce120c.jpg" },
  { label: "Химический пилинг — обновление кожи", src: "https://cdn.poehali.dev/projects/4a1b1793-1bde-4476-a16b-45471d2a62ec/files/67723e31-4eaf-4452-9d4b-3d74b96a3655.jpg" },
  { label: "Ботулинотерапия — естественная свежесть", src: "https://cdn.poehali.dev/projects/4a1b1793-1bde-4476-a16b-45471d2a62ec/files/e924cc24-cb6f-4938-be89-31113ac90a5a.jpg" },
  { label: "Уход для мужчин — кожа в лучшей форме", src: "https://cdn.poehali.dev/projects/4a1b1793-1bde-4476-a16b-45471d2a62ec/files/7224445c-c83e-4491-a676-e15f0636e846.jpg" },
];
...
export default function Index() {
  ...
  return (
    <div className="no-select" onContextMenu={(e) => e.preventDefault()}>
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          <div className="animate-fade-in-up opacity-0 delay-400" style={{ animationFillMode: "forwards" }}>
            <p className="text-white/75 text-lg mb-10 leading-relaxed max-w-2xl mx-auto"
              ...
              Более 20 лет опыта в сфере здоровья и красоты — для женщин и мужчин.
              Каждый клиент получает индивидуальный подход и результат, который виден сразу.
            </p>
          </div>
      ...
      {/* CTA BANNER */}
      <section className="py-20 px-6 relative overflow-hidden" style={{ background: "var(--brand-dark)" }}>
        <div className="absolute inset-0" style={{
          backgroundImage: "radial-gradient(circle at 80% 50%, rgba(201,168,76,0.12) 0%, transparent 60%), radial-gradient(circle at 20% 50%, rgba(201,168,76,0.06) 0%, transparent 50%)"
        }} />
        <div className="max-w-3xl mx-auto text-center relative z-10">
          <p className="text-[var(--brand-gold)] tracking-[0.3em] text-xs uppercase mb-4" style={{ fontFamily: "Golos Text, sans-serif" }}>
            Запишитесь сегодня
          </p>
          <h2 className="text-white mb-6 leading-tight" style={{
            ...
            Первый шаг к коже, которой вы гордитесь
          </h2>
          <p className="text-white/60 mb-10 text-lg" style={{ fontFamily: "Golos Text, sans-serif", fontWeight: 300 }}>
            Консультация бесплатна. Просто напишите — и вместе найдём лучшее решение для вас.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://t.me/+79037808734" target="_blank" rel="noopener noreferrer"
              className="btn-gold px-10 py-4 text-sm rounded-sm tracking-widest uppercase cursor-pointer flex items-center justify-center gap-3"
            ...
            <a href="https://wa.me/79037808734" target="_blank" rel="noopener noreferrer"
              className="btn-outline-gold px-10 py-4 text-sm rounded-sm tracking-widest uppercase cursor-pointer flex items-center justify-center gap-3"
              style={{ textDecoration: "none" }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
      ...
      <section id="contacts" className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 max-w-xl mx-auto"
              style={{ fontFamily: "Golos Text, sans-serif", fontWeight: 300 }}>
              Напишите в любой мессенджер — отвечу лично, быстро и без скриптов
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto w-full">
            <div className="space-y-4">
              ...
              <div className="mt-8 p-6 rounded-sm text-center" style={{ background: "var(--brand-cream)" }}>
                <p className="text-[var(--brand-dark)] text-lg mb-1" style={{ fontFamily: "Cormorant Garamond, serif", fontWeight: 400 }}>
                  Первичная консультация — бесплатно
                </p>
                <p className="text-gray-500 text-sm" style={{ fontFamily: "Golos Text, sans-serif", fontWeight: 300 }}>
                  Напишите в любой мессенджер — отвечаю быстро
                </p>
              </div>
            </div>
          </div>
